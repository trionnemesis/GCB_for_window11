...
* **目前採用版本**：TWGCB-01-010 **v1.0**（中華民國112年12月1日 / 1121201）。截至 2026-08-19，經複核未發現官方已發布更新版本，詳見下方「變更紀錄」。

## 變更紀錄

* **2026-08-19**：例行基準版本複核，未變更任何腳本邏輯。
    * 確認 NICS（國家資通安全研究院）現行公告仍為 **TWGCB-01-010 v1.0**（中華民國112年12月1日 / 1121201），未發現正式發布之新版本，與 2026-07-17 之複核結論一致。
    * 搜尋結果中仍持續出現「v1.1（1141105）」之說法，但多次獨立查證皆查無任何可驗證、可點擊之官方下載連結或公告佐證（NICS 官方文件索引中僅見 v1.0 相關檔案），判斷仍為不可靠資訊，故本次同樣不予採用。
    * 另留意到 NICS 已公開「115年政府組態基準GCB說明文件（預告版）」，屬預告版性質、尚未正式發布，暫不影響本專案採用版本，待正式版公告後再行複核。
    * 本工作階段之出口網路政策持續封鎖 `www.nics.nat.gov.tw`／`download.nics.nat.gov.tw`，已改以公開網路搜尋交叉比對官方文件檔名與發布資訊確認版本未變。
